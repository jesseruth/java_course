 ...
 */
public class FiguresTest extends ComponentTestFixture
{
    /** The Constant IMAGE_FILE_NAME. */
    public static final String  IMAGE_FILE_NAME         =
            "resources/finalImage.ser";
    ...
    /**
     * This object encapsulates the matching criteria for finding the
     * the drawing surface that contains the image to test.
     */
    private final Matcher   panelMatcher     =
            new ClassMatcher( GeoPlane.Panel.class );
    ...
    public void test()
    {
        // In JUnit 5, at least some Abbot tests stopped working.
        // Solution is to ensure that ComponentTestFixture.fixtureSetup()
        // is invoked.
        try
        {
            fixtureSetUp();
    ...
    private BufferedImage getPanelImage()
    {
        ...
        try
        {
            JPanel panel    = (JPanel)getFinder().find( panelMatcher );
